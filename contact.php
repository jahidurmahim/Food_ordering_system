...
<body>
    ...
    <section id="contactUsSec">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2>Contact Us</h2>
                    <p>
                        Insert contact information and a contact form here. Make it easy for visitors to reach out to you.
                    </p>
                    <ul>
                        <li>Address: 123 Restaurant Ave, City, Country</li>
